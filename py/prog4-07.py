...
Original file is located at
    https://colab.research.google.com/drive/1Tjo3WzILY-NAemOLoPx75a9n06eUG467
"""
...
# プログラム4.6と同じライブラリをインポート
# データの準備と結果の表示はプログラム4.6と同じなので省略
def main():
    test_count = 100
    ...
    rfc_balanced = RandomForestClassifier(max_depth=5, random_state=1, class_weight='balanced')
